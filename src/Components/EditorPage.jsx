...
const EditorPage = () => {
  ...
  const handleCodeSubmit = (e) => {
    ...
    setOutput("running...");
    socketRef.current.emit(ACTIONS.CHANGE_OUTPUT, {
      roomId,
      data: "running...",
    });
    ...
    axios
      .post(`http://localhost:5000/api/code/submit`, data)
      .then((res) => {
      ...
      >
        <textarea
          ...
          onChange={(e) => {
            ...
            socketRef.current.emit(ACTIONS.CHANGE_INPUT, {
              roomId,
              data: e.target.value,
            });
          }}
